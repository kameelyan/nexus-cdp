...
ALTER TABLE webhook_subscriptions DROP CONSTRAINT IF EXISTS webhook_subscriptions_signal_id_target_url_key;
ALTER TABLE webhook_subscriptions ADD CONSTRAINT webhook_subscriptions_signal_id_target_url_key UNIQUE (signal_id, target_url);
